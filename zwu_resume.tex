...
\begin{itemize}
\item Developed Android apps that collects data from thousands of subjects in real time as well as for post data analysis
\item Applied machine learning with opencv to do signal processing from Bluetooth wareable devices
\item Deployed Dlib and Opencv, improved 68 facial landmarks detection to detect eye blinks precisely.
\item Improved user friendlyness by understnding that users were not familiar with new technology to speed up clinical trials
...
\begin{itemize}
\item Designed user interface from scracth 
\item Used RESTful API and Fitbit API in Android Studio
\end{itemize}}
\vspace{.15cm}
